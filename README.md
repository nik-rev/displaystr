...
[![docs.rs](https://img.shields.io/docsrs/displaystr?style=flat-square&logo=docs.rs)](https://docs.rs/displaystr)
...
Apply [`#[display]`](https://docs.rs/displaystr/0.1.14/displaystr/attr.display.html) on `enum`s:
